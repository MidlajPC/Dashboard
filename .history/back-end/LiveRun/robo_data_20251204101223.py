...
userid = ["68355f014e6577b52aaa7066", "684ed8b2f8a8bf79bf0e4595", "68317531db31434570f3d067", "68820908d984f13a82d34868", "6888f3213651eedf2d796391"]
...
def distance_(db_data,i):
    ...
    found_key = next((k for k, v in pos[f'loc_{i+1}'].items() if isinstance(v, list) and location in v),None)
