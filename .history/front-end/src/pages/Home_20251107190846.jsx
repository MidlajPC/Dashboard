...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <div className="z-50 shadow-2xl flex-1 ">
        <Header />
        <div className="flex flex-1 pb-1 overflow-hidden min-h-0 ">
          <div className="relative home-main-div flex-1  backdrop-blur-2xl min-h ">
            <div className="relative rounded-sm shadow-lg h-full papper-effct flex flex-col ">
              ...
              <div className="flex-1 w-full max-w-full rounded-b-sm overflow-y-auto min-h-0">
                <Outlet />
              </div>
            </div>
          </div>
