      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-center w-full h-screen ">
          <div className="bg-[#111419] w-[80%] h-[80%] rounded-xl parent ">
            <div
              className=" relative h-full hide-mobile w-[40%] sm:w-[45%] md:w-[50%] lg:w-[60%] rounded-l-xl bg-cover bg-cente "
              style={{ backgroundImage: `url(${loginbg}) `, backgroundPosition: "60% center" }}
            >
