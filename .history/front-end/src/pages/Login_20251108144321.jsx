        ...
        <div className="relative z-10 flex items-center justify-center w-full h-screen ">
          <div className="bg-[#111419] w-[80%] h-[80%] rounded-xl parent ">
            ...
            >
              ...
              <div className="relative h-full flex flex-col gap-1 bg-amber-200 justify-center pl-2 md:pl-5">
                <p className="text-md sm:text-xl md:text-5xl lg:text-5xl mt-40 z-50 ">
                  WELCOME BACK !
                </p>
              </div>
            </div>
