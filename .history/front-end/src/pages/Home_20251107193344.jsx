...
const Home = () => {
  ...
  return (
    <div
      className="h-screen flex home-bg  overflow-hidden "
      // style={{ backgroundImage: `url(${bg})` }}
    >
      <div className=" sidebar w-[20px] sm:w-[30px] md:w-[40px] lg:w-[60px] !z-50 backdrop-blur-2xl flex flex-col justify-between  ">
        <div className="flex flex-col  gap-2">
          <div className="flex sidebar-div items-center title-div">
            <SiHelpscout className="icons" />
      ...
      <div className="z-50 shadow-2xl flex flex-col flex-1 ">
        <Header />
        <div className="flex flex-1 pb-1  min-h-0 ">
          <div className="relative home-main-div flex-1  backdrop-blur-2xl min-h-0 ">
            <div className="relative rounded-sm shadow-lg h-full papper-effct overflow-y-auto flex flex-col ">
              ...
              <div className="flex-1 w-full max-w-full rounded-b-sm overflow-y-aut min-h-0">
                <Outlet />
              </div>
            </div>
          </div>
