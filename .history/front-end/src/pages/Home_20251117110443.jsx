...
const Home = () => {
  ...
  return (
    <div
      className="h-screen flex flexr home-bg overflow-x-hidden overflow-y-auto"
      // style={{ backgroundImage: `url(${bg})` }}
    >
      <div className=" sidebar flex-shrink-0 !z-50 sidebar w-[30px] lg:w-[60px] backdrop-blur-2xl flex flex-col justify-between ">
