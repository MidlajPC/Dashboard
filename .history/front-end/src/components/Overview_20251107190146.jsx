...
const Overview = () => {
  return (
    <div className="flex flex-col w-full min-h-full overflow-y-auto transition-colors duration-300 pb-3">
      ...
      <div className="flex flex-col bg-amber-50 gap-5">
        ...
        <div className=" big-card col-span-1 sm:col-span-2 xl:col-span-3 mb ">
          Visual 2
        </div>
      </div>
    </div>
