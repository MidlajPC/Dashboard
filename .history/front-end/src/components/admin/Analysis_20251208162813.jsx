                      ...
                      <ul className="dropdown-ul">
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="mb-4 bg-green-600 text-white font-semibold py-2 px-6 rounded-md shadow-md hover:bg-green-700 transition-colors duration-200"
                          >
                            All Dates
                          </button>
                          <button
                            onClick={() => {
                              setstartTime(null), setendDate(null);
                            }}
                            className="mb-4 bg-green-600 text-white font-semibold py-2 px-6 rounded-md shadow-md hover:bg-green-700 transition-colors duration-200"
                          >
                            All Time
