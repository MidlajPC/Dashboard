                ...
                {(isEdit
                  ...
                  if (feild === "Role") {
                    return (
                      <select
                        ...
                        border border-black-300 focus:outline-none focus:ring-2 focus:ring-purple-500"
                        required
                      >
                  ...
                  return (
                    <input
                      key={feild}
                      className="bg-white w-full h-[50px] rounded-lg pl-[20px] text-xs mb-1 mt-1
                   border border-black-300 focus:outline-none focus:ring-1 focus:ring-purple-500"
                      placeholder={feild}
                      name={feild}
