  ...
  return (
    <div className="m-2 flex flex-col">
      <div className="mb-2 flex gap-1 ">
        ...
        <div className=" ml-1 flex items-center bg-amber-900 ">
          <FaFilePdf onClick={downloadPdf} className=" h:[30px] w-[25px] lg:h-[35px] lg:w-[30px]" />
        </div>
        <div className="flex items-center">
          <BsFiletypeXlsx
            onClick={downloadExcel}
            className=" h:[30px] bg-amber-500 w-[20px] lg:h-[35px] lg:w-[30px]"
          />
        </div>
      </div>
