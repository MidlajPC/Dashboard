                      ...
                      <ul className="dropdown-ul">
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="bg-blue-600 text-white font-semibold py-2 px-5 rounded- shadow-md hover:bg-blue-700 transition-colors duration-200"
                          >
                            Apply
                          </button>
                          <button
                            onClick={toggleDrpDwn}
                            className="bg-gray-200 text-gray-800 font-semibold py-2 px-5 rounded- shadow-sm hover:bg-gray-300 transition-colors duration-200"
                          >
                            Cancel
                          </button>
                        </div>
