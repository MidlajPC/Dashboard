...
const Map = () => {
  ...
  return (
    <div className="m-2 flex flex-1 flex-col ">
      ...
      <div className="w-full h-[calc(100vh-190px)] flex flex-col md:flex-row overflow-y-auto ">
        ...
        {selectedPin && (
          <div className="flex flex-col gap-1 overflow-y-auto pb-2 bg-amber-800">
            ...
            </div><div className=" bg-white w-[100px] flex-1 overflow-hidden !rounded-sm">
