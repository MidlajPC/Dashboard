  ...
  useEffect(() => {
    ...
    if (search.trim().length > 0) {
      filtered = filtered.filter((log) => {
        ...
        ) || log.operators[0].user.name.toLowerCase() || log.operators[0].user.email.toLowerCase() || log.data[0].operator.name.toLowerCase()|| log.data[0].operator.name.toLowerCase()
      });
    }
