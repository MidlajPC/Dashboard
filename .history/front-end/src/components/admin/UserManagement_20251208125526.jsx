...
const UserManagement = () => {
  ...
  }, [isEdit, isAddUserOpen, users, activityStatus]);
  useEffect(() => {
    const handleFilter = () => {
                    ...
                    return (
                      <div className="relative">
                        <select
                          ...
                          className="custom-select bg-white w-full h-[50px] rounded-lg pl-[20px] text-xs mb-1 mt-1
                        ...
                        <span className="custom-arrow text-black text-sm">
                          ▼
                        </span>
                      </div>
                    );
                    ...
                    return (
                      <div className="relative">
                        <select
                          ...
                          className="custom-select bg-white w-full h-[50px] rounded-lg pl-[20px] pr-[40px] text-xs mb-1 mt-1
              border border-black-300 focus:outline-none"
                          required
                        >
